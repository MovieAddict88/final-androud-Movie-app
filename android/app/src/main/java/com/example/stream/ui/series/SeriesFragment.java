package com.example.stream.ui.series;
...
public class SeriesFragment extends Fragment {
    public static SeriesFragment newInstance() { return new SeriesFragment(); }
    ...
    private void load() {
        ApiClient.getInstance().getContents("series", selectedCategoryId, 1, 50).enqueue(new Callback<Map<String, Object>>() {

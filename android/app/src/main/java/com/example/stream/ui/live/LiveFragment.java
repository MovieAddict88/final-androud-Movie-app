package com.example.stream.ui.live;
...
public class LiveFragment extends Fragment {
    public static LiveFragment newInstance() { return new LiveFragment(); }
    ...
    private void load() {
        ApiClient.getInstance().getContents("live", selectedCategoryId, 1, 100).enqueue(new Callback<Map<String, Object>>() {
